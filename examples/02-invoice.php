...
$inv = $simpleshop_api->createInvoice($opt);    // vytvoříme novou fakturu
//$inv = $simpleshop_api->invoice_setPayment($inv['id']);    // vytvoříme novou fakturu
...
$inv2 = $simpleshop_api->updateInvoice($_ID_DOKUMENTU, $opt);    // upravíme fakturu
...
$inv3 = $simpleshop_api->getInvoice($_ID_DOKUMENTU);
...
$inv4 = $simpleshop_api->deleteInvoice($_ID_DOKUMENTU);

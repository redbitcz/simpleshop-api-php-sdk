...
$contact = $simpleshop_api->createContact($opt);    // vytvoříme novou fakturu
...
$contact2 = $simpleshop_api->updateContact($_ID_KONTAKTU, $opt);    // upravíme kontakt
...
$contact3 = $simpleshop_api->getContact($_ID_KONTAKTU); // načte 1 konkrétní kontakt
// $contact3 = $simpleshop_api->getContacts();  // vrátí všechny moje kontakty
...
$contact4 = $simpleshop_api->deleteContact($_ID_KONTAKTU);

...
$opt = array(// šablona, kterou si přejeme odeslat
    'type' => 3,
    'to' => 'demo@simpleshop.cz',// lze také použit tento zápis: 'demo1@simpleshop.cz, demo2@simpleshop.cz'
//    'cc' => '',
//    'bcc' => '',
...
$res = $simpleshop_api->invoice_sendMail_test($_ID_DOKUMENTU, $opt);    // Získáme šablonu, co by se odeslalo
...
$res = $simpleshop_api->invoice_sendMail($_ID_DOKUMENTU, $opt);    // Odešleme e-mail
